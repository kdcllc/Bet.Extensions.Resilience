...
{
    public interface IRetryPolicy<TOptions> : IPolicy<TOptions> where TOptions : RetryPolicyOptions
    {
    ...
    public interface IRetryPolicy<TOptions, TResult> : IPolicy<TOptions, TResult> where TOptions : RetryPolicyOptions
    {
