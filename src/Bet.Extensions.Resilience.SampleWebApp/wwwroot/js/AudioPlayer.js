//https://raw.githubusercontent.com/likev/html5-audio-player/master/js/AudioPlayer.js
; (function (window, undefined) {
    ...
    var AudioPlayer = (function () {
        ...
        var aphtml =
            ...
            '  <div class="ap-inner">' +
            '  <div class="ap-current-icon" id="icon">' +
            '  </div>' +
            '    <div class="ap-panel">' +
        ...
        function init(options) {
            ...
            currentIcon = player.querySelector('.ap-current-icon');
        ...
        function renderIcon(song) {

            currentIcon.innerHTML = '<img src="' + song.icon + '" height="300" width="300"/>';
        }
