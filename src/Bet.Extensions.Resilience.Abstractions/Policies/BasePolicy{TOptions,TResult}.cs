...
{
    /// <summary>
    /// The base class of <see cref="IPolicy{TOptions, TResult}"/> interface implementation.
    /// </summary>
    /// <typeparam name="TOptions">The type of the options.</typeparam>
    /// <typeparam name="TResult">The type of the policy result.</typeparam>
    public abstract class BasePolicy<TOptions, TResult> : IPolicy<TOptions, TResult>, IDisposable where TOptions : PolicyOptions
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BasePolicy{TOptions, TResult}"/> class.
        /// </summary>
        ...
        /// <inheritdoc/>
        public abstract ISyncPolicy<TResult> GetSyncPolicy();
